...
namespace Chess.Figures
{
    class Bishop:Figure
    {
        public Bishop(int figurecolor, char figurechar, int posx, int posy)
        {
        ...
        {
            if (Math.Abs(EnterNewPosX - posx) == Math.Abs(EnterNewPosY - posy))
            {
                bool wayfree = false;
            ...
            {
                Console.WriteLine("Bishop can`t move this way");
            }
        }
    }
}
